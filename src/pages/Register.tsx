    ...
    <div className="flex-1 flex flex-col items-center justify-center p-4 min-h-screen bg-white font-sans text-stone-900 border-x-2 border-stone-900 max-w-[1400px] mx-auto w-full relative">
      ...
      <div className="w-full max-w-md bg-white border-2 border-stone-900 shadow-[8px_8px_0_0_#1c1917] p-8">
        <div className="text-center mb-8 border-b-2 border-stone-900 pb-6">
          ...
          <h2 className="font-serif italic text-[11px] text-stone-500 uppercase tracking-[0.2em]">System Registration</h2>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="font-mono block text-xs font-bold text-stone-900 uppercase tracking-widest mb-2">Name</label>
            <input 
              type="text" required
          ...
          <div>
            <label className="font-mono block text-xs font-bold text-stone-900 uppercase tracking-widest mb-2">Email</label>
            <input 
              type="email" required
              className="w-full px-4 py-3 bg-stone-50 border-2 border-stone-300 text-sm font-bold text-stone-900 focus:bg-white focus:border-stone-900 outline-none transition-colors placeholder:text-stone-400 placeholder:font-sans placeholder:font-normal"
          ...
          <div>
            <label className="font-mono block text-xs font-bold text-stone-900 uppercase tracking-widest mb-2">Password</label>
            <input 
          ...
          <div>
            <label className="font-mono block text-xs font-bold text-stone-900 uppercase tracking-widest mb-2">Role Assignment</label>
            <div className="relative">
              <select 
                className="w-full px-4 py-3 bg-stone-50 border-2 border-stone-300 text-sm font-bold text-stone-900 focus:bg-white focus:border-stone-900 outline-none transition-colors appearance-none cursor-pointer"
        ...
        <div className="mt-8 pt-6 border-t-2 border-stone-100 text-center font-mono text-xs font-bold text-stone-500 uppercase tracking-widest">
          Already have an account? <Link to="/login" className="text-indigo-600 hover:text-indigo-800 ml-2 relative group">SIGN IN
